...
public class PController {
    ...
    public double getComputedOutput(double input) {
        ...
        //currentError = Math.abs(Math.abs(setPoint) - Math.abs(input)); Changed becsue it wont work with turret when -300 and trying to get to 300 _CG
        currentError = Math.abs(setPoint - input);
